...
class Board extends Component {
    constructor(props) {
      ...
      this.puzzle = [
        ...
        this.updateWithJsonResponse = this.updateWithJsonResponse.bind(this);
    }
    ...
    updateWithJsonResponse(json) {
        if ((json == null) || (json.puzzle == null) || (json.puzzle.grid == null))
        {
            console.log("Input JSON parameter is null.  Cannot update board with data.");
            return;
        }
